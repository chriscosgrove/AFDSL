...
namespace afdsl_Web_Application.afdsl_UserControls.Gallery_UserControls
{
    public partial class afdsl_Gallery : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (NumberOfPosts != 0)
            {
                rptGalleryItems.DataSource = galleryItemList = galleryItemList.Take(NumberOfPosts).ToList();
            }
            else
            {
                rptGalleryItems.DataSource = galleryItemList = galleryItemList.ToList();
            }
